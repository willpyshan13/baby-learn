<template>
  <el-dialog width="" :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
    <el-form :rules="rules" ref="cartoonForm" :model="cartoon" label-width="90px"
             style='width:85%;margin-left:20px;' size="small">
      <el-row>
        <el-col :span="12">
    ...
    data() {
      return {
        ...
        rules: {
          ...
          videoWheelPicUrl: [{ required: false, notNullMessage: '剧集图为必填项', TypeErrorMessage: '请上传正确类型的文件', trigger: 'change', validator: validateImage }]
        }
      }
    },
    methods: {
