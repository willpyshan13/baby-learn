    ...
    data() {
      return {
        ...
        gameRules: {
          ...
          imageUrl: [{ required: false, notNullMessage: '游戏图片为必填项', TypeErrorMessage: '请上传正确类型的文件', trigger: 'change', validator: validateImage }],
          resourceUrl: [{ required: true, notNullMessage: '音频地址为必填项', TypeErrorMessage: '请上传正确类型的文件', trigger: 'change', validator: validateAudio }]
        }
      }
    },
    methods: {
