      ...
      <el-row>
        <el-col :xs="24" :sm="10" :md="8" :lg="6" :xl="4">
          <el-form-item label="用户类型:" prop="userType">
            <el-select v-model="sysUserFormObject.userType" placeholder="请选择用户类型">
              <el-option
      ...
      <el-row>
        <el-col :xs="24" :sm="10" :md="8" :lg="6" :xl="4">
          <el-form-item label="姓名拼音:" prop="namePinyin">
            <el-input v-model="sysUserFormObject.namePinyin"/>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        ...
        rules: {
          ...
          namePinyin: [{ required: true, message: '姓名拼音为必填项', trigger: 'change' }],
    ...
    methods: {
      ...
      handleBack() {
        closeCurrentView(this.$store, this.$router, this.$route.path, '/system/users')
      },
