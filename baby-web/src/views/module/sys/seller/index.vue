<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <router-link :to="'/system/sellers/add'">
        <el-button
          class="filter-item"
          type="primary"
          icon="el-icon-edit"
    ...
    <el-table
      ...
      <el-table-column label="操作" width="240" align="">
        <template slot-scope="scope">
          <el-button v-if="false" type="primary" size="mini" @click="handleRoleSelect(scope.row.id)">分配角色</el-button>

          <router-link :to="'/system/sellers/edit/' + scope.row.id">
            <el-button
              class="filter-item"
              type="primary"
              size="mini">
